    ...
    <div className="bg-black text-white">
      ...
      <div className="flex justify-center p-20 items-center">
        <div>
          ...
          <h2 className="text-center text-3xl font-bold">Modern time management, Simple,elegant,powerfull.</h2>
          <div className="text-center mt-10 ">

          <button className=" px-10 py-3 rounded-lg bg-white text-black mb-20">Get started</button>
          </div>
        </div>
      </div>
